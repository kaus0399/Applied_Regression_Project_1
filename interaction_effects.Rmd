...
```{r}
library(readr)
urlfile <- "https://raw.githubusercontent.com/kaus0399/Applied_Regression_Project_1/main/final_data.csv?token=AOLVKLJMFIULMFDOWJPFISDBQGPXM"
...
table_and_int_plot <- function(x, y) {
  ...
  print(freq_table)
  interaction.plot(x, y, train$summedRevenue_log, col = 1:15)
}
