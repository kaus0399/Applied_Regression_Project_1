...
new_data = data1[!is.na(data1$totals.transactionRevenue),]
```
...
final_data2$device.browser <- recode(final_data2$device.browser, "'Chrome'='Chrome'; 'Safari'='Safari'; 'Safari (in-app)'='Safari'; else='Other'")
final_data2$device.operatingSystem <- recode(final_data2$device.operatingSystem, "'Windows Phone'='Windows'; 'Macintosh'='iOS'")
final_data2$geoNetwork.country <- recode(final_data2$geoNetwork.country, "'United States'='United States'; 'Canada'='Canada'; else='Other'")
final_data2$trafficSource.source <- recode(final_data2$trafficSource.source, "'(direct)'='(direct)'; 'google'='google'; 'mall.googleplex.com' = 'mall.googleplex.com'; else='Other'")
```
